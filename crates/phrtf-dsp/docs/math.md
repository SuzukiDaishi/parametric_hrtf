...
デフォルトでは、`hrtf_debug/sofa` に置いた RIEC ダミーヘッド SOFA を見ながら、
正中面 0..180° のアンカーを補間しています。P1/P2は固定、N1/N2の中心周波数・
レベル・Qだけを仰角で動かします。

```text
beta:       0     30     60     90    120    150    180 deg
N1 delta:   0   2200   2700   3000   3100   2600   1100 Hz
N2 delta:   0    900   2600   3400   3900   3400   3000 Hz
```

アンカー間は smoothstep で補間します。N1は真上付近でかなり浅く広くし、N2は
N1ほど消さずに高域の補助手掛かりとして残します。

旧モード `IidaLikePolynomialHzScale` では、Hzスケールの動きになる多項式係数を
使えます。
