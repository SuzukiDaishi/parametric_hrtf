...
また、このpHRTFは正中面モデルなので、真横方向ではP/Nスペクトル成分を弱めています。
左右定位は主にITD/ILD/head shadowで作り、真横を「真上」と同じ強さのpHRTFにしないことで、左右方向だけ過度にこもる副作用を避けます。

### P/N構成

- P1: 4〜6kHz付近の固定ピーク
- P2: 6〜9kHz付近の固定補助ピーク
- N1: 仰角で中心周波数・深さ・Qが動く第1ノッチ
- N2: 仰角で中心周波数・深さ・Qが動く第2ノッチ
